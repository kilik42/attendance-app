...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="AttendanceAppKing",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC17AttendanceAppKing11AppDelegate")
...
SWIFT_CLASS("_TtC17AttendanceAppKing23MenuTableViewController")
...
SWIFT_CLASS("_TtC17AttendanceAppKing13SceneDelegate")
...
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified tardies;
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified absences;
